    ...
    <div className="Hero-main h-[100vh]">
      <div className="Hero">
        <div className="flex justify-between px-4 lg:px-32 items-center h-[80px]">
          ...
          <div>
            <button className="bg-[red] text-[white] px-8 py-1 rounded-md font-semibold">
              Sign in
            </button>
          </div>
        </div>
            ...
            <div className="sm:flex justify-center items-center gap-4 mt-20">
              <form className="flex px-4 flex-wrap gap-4">
                <input
                  ...
                  required
                  className="text-[white] w-[100%] bg-transparent border border-white px-4 sm:w-[350px] py-2"
                ></input>
