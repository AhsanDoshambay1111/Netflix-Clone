...
function Moviespost2() {
  ...
  useEffect(() => {
    const fetchMoviePosters = async () => {
      try {
        const response = await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=c0ecc0827ae80b4f6f294bd368becbfc&with_original_language=hi&year=2022&page=${page}`);
